        ...
        <div class="col-lg-10 col-xl-8">
          <div class="detail-card">
            <div class="detail-card-header">
              <h2 class="detail-title">Edit Materi</h2>
            </div>
            <div class="detail-content">
              <form action="/admin/update/<?= $inovasi['id']; ?>" method="post" enctype="multipart/form-data" class="create-form">

                <?= csrf_field(); ?>

                <input type="hidden" name="slug" value="<?= $inovasi['slug']; ?>">
                <input type="hidden" name="gambarLama" value="<?= $inovasi['gambar']; ?>">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="judul" name="judul"
                    ...
                    placeholder="Masukkan Judul" value="<?= old('judul', $inovasi['judul']); ?>">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="tagline" name="tagline"
                    class="form-control <?= session('errors.tagline') ? 'is-invalid' : ''; ?>"
                    placeholder="Masukkan Tagline" value="<?= old('tagline', $inovasi['tagline']); ?>">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="subjudul" name="subjudul"
                    class="form-control <?= session('errors.subjudul') ? 'is-invalid' : ''; ?>"
                    placeholder="Masukkan Subjudul" value="<?= old('subjudul', $inovasi['subjudul']); ?>">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="subkonten" name="subkonten"
                    class="form-control <?= session('errors.subkonten') ? 'is-invalid' : ''; ?>"
                    placeholder="Masukkan Subkonten" value="<?= old('subkonten', $inovasi['subkonten']); ?>">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="judul_info" name="judul_info"
                    class="form-control <?= session('errors.judul_info') ? 'is-invalid' : ''; ?>"
                    placeholder="Masukkan Judul Info" value="<?= old('judul_info', $inovasi['judul_info']); ?>">
                ...
                <div class="mb-4">
                  ...
                  <textarea class="form-control <?= session('errors.deskripsi') ? 'is-invalid' : ''; ?>"
                    ...
                    placeholder="Masukkan Deskripsi"><?= old('deskripsi', $inovasi['deskripsi']); ?></textarea>
                ...
                <div class="mb-4">
                  ...
                  <div class="input-gambar-wrapper">
                    <img id="preview-img" src="/images/<?= $inovasi['gambar']; ?>" class="input-gambar-preview">
                ...
                <div class="mb-4">
                  ...
                  <input type="text" id="video_url" name="video_url"
                    class="form-control <?= session('errors.video_url') ? 'is-invalid' : ''; ?>"
                    placeholder="Contoh: dQw4w9WgXcQ" value="<?= old('video_url', $inovasi['video_url']); ?>">
                ...
                <!-- Tombol -->
                <div class="mt-4">
                  <a href="/admin/detail/<?= $inovasi['slug']; ?>" class="btn btn-secondary rounded-pill">Batal</a>
